package itAcademy.ORM.mapper;

import itAcademy.ORM.annotation.*;
import itAcademy.ORM.mapper.exceptions.*;
...
public class EntityInspector {
        ...
        for(java.lang.reflect.Field f : this.clazz.getDeclaredFields()){
            ...
            if(!Modifier.isTransient(modifiers) && !Modifier.isVolatile(modifiers)){
                ...
                if (!(Modifier.isPublic(modifiers))){
                    // if setter does not exist, throw exceptions.
                    ...
                    // if getter does not exist, throw exceptions.
                ...
                // Recognize @PrimaryKey annotation
                ...
                /**
                 ** Recognize @OnyToOne, @OneToMany, @ManyToMany annotations
                 **/
     ...
     * {@link PrimaryKey} in terms of its variable type.
     *
     * @param type of some field to be an {@link PrimaryKey} candidate.
    ...
    private static Method findGetterFor(Class<?> forClass, final String fieldName) {
        ...
        if (m != null && m.getParameterTypes().length == 0
                && !m.getReturnType().equals(Void.TYPE)) // non-void and no arguments
            return m;
        else return null;
    }
     ...
     * default constructors are declared, throws exceptions.
     *
