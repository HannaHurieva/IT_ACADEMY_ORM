...
public class Entity {
     ...
     * {@link itAcademy.ORM.annotation.Entity} annotated classes.
     *
     * @param clazz
    ...
    public Entity(Class<?> clazz) {
        if (!clazz
                .isAnnotationPresent(itAcademy.ORM.annotation.Entity.class))
        ...
        String tmpCustomName = clazz.getAnnotation(
                itAcademy.ORM.annotation.Entity.class).table();
    ...
    public Field getFieldByName(String fieldName) {
        Entity e = MappingSession.getEntity(getType());
        if (e == null)
            throw new EntityNotFoundException(getType().getName());
