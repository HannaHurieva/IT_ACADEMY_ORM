...
public class CrudOperationsImpl implements CrudOperations {
    ...
    private String insertBy(Object obj, LinkedHashMap<String, Object> fields) {
        Set<String> fieldsSet = fields.keySet();
    ...
    public Object insert(Object obj) {
        ...
        Set<String> fieldsSet = fields.keySet();
        try (PreparedStatement preparedStatement = connection.prepareStatement(insertBy(obj, fields))) {
            Iterator<String> it = fieldsSet.iterator();
            int i = 1;
            while (it.hasNext()) {
    ...
    private ArrayList<Object> findBy(String where, Class classObject, Object... params) {
